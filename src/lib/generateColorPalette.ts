...
export function generateAccentPalette(
  ...
  return {
    scaleHSL: accentScale.map((color: Color) => color.to("hsl").toString()),
    scaleRGB: accentScale.map((color: Color) => color.to("srgb").toString()),
...
export function generateGrayPalette(
  ...
  return {
    scaleHSL: grayScale.map((color: Color) => color.to("hsl").toString()),
    scaleRGB: grayScale.map((color: Color) => color.to("srgb").toString()),
    scale: grayScaleHex,
